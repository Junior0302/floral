      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-12 md:grid-cols-3 md:gap-16">
          <div>
            <Link href="/" className="group inline-flex items-center gap-3" data-cursor="hover">
              <Image
                ...
                width={26}
                height={26}
                className="drop-shadow-[0_2px_8px_rgba(255,255,255,0.25)] transition-transform duration-500 group-hover:scale-110"
              />
              <span className="flora-title font-playfair text-lg tracking-[0.22em] transition-colors duration-300 group-hover:text-flora-coral">
                FLORA
              </span>
            </Link>
            ...
            <nav className="flex flex-col gap-2">
              {footerLinks.map((link) => (
                <Link
                  ...
                  data-cursor="hover"
                  className={cn(
                    "flora-footer-link font-poppins text-[15px]",
                    pathname === link.href && "flora-footer-link-active"
                  )}
                >
                  {link.label}
                </Link>
          ...
          <div>
            ...
            <form
              className="flex items-end gap-4 border-b border-white/20 pb-2 transition-colors duration-300 focus-within:border-flora-coral/70"
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              {[
                ...
                <a key={label} href="#" aria-label={label} data-cursor="hover" className="flora-icon-btn">
                  <Icon size={17} strokeWidth={1.75} />
                </a>
              ))}
              <a href="#" aria-label="Pinterest" data-cursor="hover" className="flora-icon-btn">
